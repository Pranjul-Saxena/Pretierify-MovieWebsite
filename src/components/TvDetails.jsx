      ...
      <div
        ...
        <div className='w-full '>
          ...
          <div className='p-10 text-xl font-semibold text-white flex flex-row'>
            ...
            />
            <div>
              <div className='CrimsonPro flex items-center text-center'>
                <h1 className='text-5xl pl-10'>{info.detail.title || info.detail.name || info.detail.origanal_name || info.detail.original_title}</h1>
                <h1 className='text-3xl pl-4 text-zinc-400'>({info.detail.first_air_date.substring(0, 4)})</h1>
              </div>
              <h1 className='text-4xl pl-10'>{info.detail.tagline}</h1>
              <h1 className='text-2xl pl-11 py-4'>Overview </h1>
              <p className='text-sm text-gray-200 pl-11'>{info.detail.overview}</p>
              <h1 className='text-2xl pl-11 pt-4'>TV Translated </h1>
              <p className='text-sm text-gray-200 pl-11 pt-4'>{info.translations.join(", ").slice(0, 165)}, etc</p>
        ...
        <hr className='h-[1px] mb-10 mt-[4%] bg-zinc-400 border-none' />
        <h1 className='text-3xl  text-zinc-300'>Similar tvs </h1>
